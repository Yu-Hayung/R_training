...
myStopwords = c(stopwords('english'), '','하기');   # 제거할 단어 지ᄌ
...
# matrix 자료 구조를 data.frame 자료구조로 변경
...
wordResult[1:20]  # 빈도수가 높은  10개 단어 보기 
...
wordcloud2(data = df , fontFamily = '나눔바른고ᄃ')

############
# 2. 마틴 루터킹 연설문 연관 분석  
############
...
tranrules <- apriori(wordtran, parameter = list(supp = 0.9, conf = 0.05, target="rules"))
